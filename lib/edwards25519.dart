...
void squareModL(out, Uint8List z) {
...
void multModL(out, z, Uint8List w) {
  // we keep the old commands for benchmarking
  // var zero [32]byte
...
//   where l = 2^252 + 27742317777372353535851937790883648493.
void ScMul(Uint8List s, Uint8List a, Uint8List b) {
  var a0 = 2097151 & load3(a);
  var a1 = 2097151 & (load4(a.sublist(2, a.length)) >> 5);
  var a2 = 2097151 & (load3(a.sublist(5, a.length)) >> 2);
  var a3 = 2097151 & (load4(a.sublist(7, a.length)) >> 7);
  var a4 = 2097151 & (load4(a.sublist(10, a.length)) >> 4);
  ...
  var b10 = 2097151 & (load3(b.sublist(26, b.length)) >> 2);
  var b11 = (load4(b.sublist(28, b.length)) >> 7);
  Uint64List carry = new Uint64List(23);

  var s0 = a0 * b0;
  var s1 = a0 * b1 + a1 * b0;
  var s2 = a0 * b2 + a1 * b1 + a2 * b0;
  var s3 = a0 * b3 + a1 * b2 + a2 * b1 + a3 * b0;
  var s4 = a0 * b4 + a1 * b3 + a2 * b2 + a3 * b1 + a4 * b0;
  var s5 = a0 * b5 + a1 * b4 + a2 * b3 + a3 * b2 + a4 * b1 + a5 * b0;
  var s6 = a0 * b6 + a1 * b5 + a2 * b4 + a3 * b3 + a4 * b2 + a5 * b1 + a6 * b0;
  var s7 = a0 * b7 +
      a1 * b6 +
      a2 * b5 +
      a3 * b4 +
